<x-app-layout>
    ...
    <x-container>
        <div class="max-w-2xl shadow-sm bg-white border rounded-lg p-6">
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ route('profile.edit') }}"
                        class="underline text-sm text-zinc-600 hover:text-zinc-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 pt-0.5">
                        Edit Profile
                    </a>
